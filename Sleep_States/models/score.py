# This file contains the code for the event detection average precision metric
# as provided by competition hosts: https://www.kaggle.com/code/metric/event-detection-ap/notebook
...
def score(
    ...
    for column_name in [
        ...
        if column_name not in submission.columns:
            ...
            # comment NM: the variable target_name used above is not defined, they probably want to use column_name
            # but ideally we won't get this error if we define the column names well in the function parameters
